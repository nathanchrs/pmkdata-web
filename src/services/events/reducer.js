...
import { FETCH_EVENTS_REQUEST, FETCH_EVENTS_SUCCESS, FETCH_EVENTS_FAILURE, UPDATE_EVENT_SUCCESS } from './actions';
...
export default addPagination(eventsReducer, 'events');
